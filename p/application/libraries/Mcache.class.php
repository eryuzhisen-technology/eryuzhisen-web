...
define('MODID',194433);
define('CMD',65536);
define('BID',101020962);
define('HOST',"10.224.130.213");//10.224.131.82//10.219.138.218
define('PORT',9101);
...
class Mcache
{
    ...
    { 
        ...
        //print_r($ret);
        //print_r($this->router);
        //$ret = configcenter4_get_cmd_l5(CMD, 0, MODID);
        //print_r($ret);
        //if($ret == 1){
    ...
    public static function &getMemCache($server)
    {
        ...
        if (!isset($instance))
        {
            ...
            */
            //
            if(method_exists($instance,"config_l5_sid")){
                $timeout_ms = 200;
                $l5_timeout_s = 300;
                $instance->config_l5_sid(MODID, CMD, $timeout_ms, $l5_timeout_s);
            }
            else{
     ...
     * @return boolean
     */
    function setCache($app_name, $var_name, $data, $expire_seconds=0)
    {
        $cas = -1;
